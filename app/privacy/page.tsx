        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInSection>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-gray-900">第1条（個人情報の定義）</h2>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-gray-900">第2条（個人情報の収集方法）</h2>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-gray-900">第3条（個人情報の利用目的）</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-gray-900">第4条（個人情報の第三者提供）</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-gray-900">第5条（個人情報の安全管理）</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-gray-900">第6条（個人情報の開示・訂正・削除等）</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-gray-900">第7条（本ポリシーの変更）</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-gray-900">第8条（お問い合わせ窓口）</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。
              </p>
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-700 font-bold mb-2">Film Studio K</p>
                <p className="text-gray-700">住所：〒920-0000 石川県金沢市三口町金9-12</p>
                <p className="text-gray-700">お問い合わせフォーム：<a href="/contact" className="text-blue-600 hover:underline">こちら</a></p>
              </div>
            </section>

            <p className="text-right text-gray-600 mt-12">制定日：2025年11月15日</p>
            </div>
          </FadeInSection>
        </div>
      </section>
